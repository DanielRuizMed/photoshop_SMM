...
/**
 * Clase para crear rectángulos redondeados que hereda de la clase DFormas.
 *
 * @author: Daniel Ruiz Medina
 * @version: 01/06/2021
 */
public class DRectanguloRounds extends DFormas{
     ...
     * la figura.
     */
    public DRectanguloRounds(){
        super();
        forma = new RoundRectangle2D.Double(0,0,0,0,30,30);
        super.setNombre("Rectángulo rendondeado");
    }

    /**
     * Modificar si la figura tiene el color de fondo degradado activo y crea 
     * el nuevo degradado, con los puntos de la forma.
     *
